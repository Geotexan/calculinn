	...
	$.each(carreteras_gtx, function(i, item) {
		if (carreteras_gtx[i]['Dmax'] == d && carreteras_gtx[i]['Espesor'] == e &&
			carreteras_gtx[i]['CBR'] == cbr) {
				...
				$('#rt-geotextil-value').val(carreteras_gtxtil[i]['RT']);
				$('#elong-geotextil-value').val(carreteras_gtxtil[i]['ELONG']);
				$('#cbr-geotextil-value').val(carreteras_gtxtil[i]['RCBR']);
				$('#perfcono-geotextil-value').val(carreteras_gtxtil[i]['RPERF_CONO']);
				$('#abcono-geotextil-value').val(carreteras_gtxtil[i]['AB_PORO']);
				$('#product').val(carreteras_gtxtil[i]['GEOTESAN']);
				result = true;
				return false;;
